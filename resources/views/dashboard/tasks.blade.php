...
<div class="card mb-4 mb-md-5 border-0 ">
    <div class="card-header p-0 bg-primary rounded-top "
        ...
        <h3 class="px-4 pb-2  text-white py-4 fs-20 fw-700"><b>Pending Tasks</b></h3>
    </div>
    <div class="card-body p-0 ">
        <div class="list-group list-group-flush p-0">
            @foreach ($items as $item)
                <hr class="p-0 m-0">
               {{--  <a href="{{ admin_url('tasks/' . $item->id) }}" target="_blank" title="View Event Details" --}}
                <a href="{{ admin_url('tasks-pending') }}" target="_blank" title="View Event Details"
