...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ url('') }}/assets/img/logo1.jpg">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ url('') }}/assets/img/logo1.jpg">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ url('') }}/assets/img/logo1.jpg">
    <link rel="manifest" href="{{ url('') }}/assets/favicon/site.webmanifest">
    <link rel="mask-icon" href="{{ url('') }}/assets/img/logo1.jpg" color="#6366f1">
    <link rel="shortcut icon" href="{{ url('') }}/assets/img/logo1.jpg">
